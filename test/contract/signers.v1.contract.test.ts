...
import fixtureV1 from '../fixtures/v1/testnet-valid-1.2.json';
  ...
  describe('signers property', function () {
    describe('given there is only one signature to the blockcerts document', function () {
      ...
      it('should expose the signatureSuiteType', function () {
        expect(instance.signers[0].signatureSuiteType).toBe('ChainpointSHA256v2');
      });
      ...
      it('should expose the transactionLink', function () {
        expect(instance.signers[0].transactionLink).toBe('https://testnet.blockchain.info/tx/8623beadbc7877a9e20fb7f83eda6c1a1fc350171f0714ff6c6c4054018eb54d');
      });

      it('should expose the rawTransactionLink', function () {
        expect(instance.signers[0].rawTransactionLink).toBe('https://testnet.blockchain.info/rawtx/8623beadbc7877a9e20fb7f83eda6c1a1fc350171f0714ff6c6c4054018eb54d');
      });
    });
  });
});
