...
A legacy library to parse and verify [Blockcerts](https://www.blockcerts.org/) v1 documents. This library will not be receiving support and maintainance, and is provided for legacy support only.

### [The active library to parse and verify Blockcerts v2 & v3 is here](https://github.com/blockchain-certificates/cert-verifier-js)
