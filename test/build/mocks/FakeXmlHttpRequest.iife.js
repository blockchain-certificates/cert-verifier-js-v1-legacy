const mockXHR = (function (exports) {
  'use strict';

  const id = 'http://www.blockcerts.org/mockissuer/issuer/got-issuer_live.json';
  const url = 'http://www.blockcerts.org/mockissuer/certificates/';
  const introductionURL = 'http://www.blockcerts.org/mockissuer/intro/';
  const name = 'Game of thrones issuer on mainnet';
  const email = 'org@org.org';
